...
from predictor.views import home  # Import the home view
from predictor import views
from django.contrib.auth import views as auth_views

urlpatterns = [
    path('', home, name='home'),  # Root path for home view
    path('admin/', admin.site.urls),
    path('predictor/', include('predictor.urls')),  # Include predictor URLs
